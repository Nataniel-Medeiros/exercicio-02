...
### 4. Instalar Dependências Manualmente (se necessário)
```bash
pip install tclab pandas numpy matplotlib plotly dash
```
...
│   ├── 📄 tclab_data_float16_int8_10080min_noH.csv
│   └── 📄 tclab_data_histerese_float16_int8_10080min.csv
